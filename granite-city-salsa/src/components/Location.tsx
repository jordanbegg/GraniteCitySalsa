        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 md:order-1">
            <img 
              ...
              className="w-full rounded-2xl shadow-2xl hover:scale-105 transform transition duration-500"
            />
          </div>
          ...
          <div className="order-1 md:order-2">
            ...
            <div className="space-y-6 text-gray-300">
              ...
              <div className="bg-gray-800 rounded-lg p-6 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <Navigation className="w-6 h-6 text-green-400 flex-shrink-0 mt-1" />
                  <div>
              ...
              <a 
                ...
                className="inline-block bg-gradient-to-r from-green-500 to-green-600 text-white font-bold px-8 py-4 rounded-full hover:scale-105 transform transition shadow-lg"
              >
                📍 Get Directions
              </a>
            </div>
